...
-- Dumping data for table hplydb_new.t_arrears: ~3 rows (approximately)
...
-- Dumping data for table hplydb_new.t_collections: ~472 rows (approximately)
...
-- Dumping data for table hplydb_new.t_contract_change: ~37 rows (approximately)
...
-- Dumping data for table hplydb_new.t_customer_billing: ~108 rows (approximately)
...
-- Dumping data for table hplydb_new.t_party_billing: ~111 rows (approximately)
...
-- Dumping data for table hplydb_new.t_payment: ~184 rows (approximately)
...
-- Dumping data for table hplydb_new.t_profile: ~86 rows (approximately)
...
-- Dumping data for table hplydb_new.t_project: ~210 rows (approximately)
...
-- Dumping data for table hplydb_new.t_project_summary: ~5,369 rows (approximately)
...
INSERT INTO `t_sys_parameter` (`id`, `en_name`, `cn_name`, `param_value`, `default_value`, `is_inner`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`) VALUES
	('0b8f1d89-8655-463a-97be-b8b033d29a8c', 'collections_code', '收款凭证号', '4171', 'SK', b'0', '2014-08-08 23:47:26', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-09-06 08:30:49', 'mysql.get_next_code', 'SK-2014-0001', 4),
	...
	('1fdae036-8ba5-4ad5-ad43-e68e38eda5e0', 'arrears_code', '往来欠款凭证号', '49', 'WL', b'0', '2014-08-08 23:52:38', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-09-06 07:43:06', 'mysql.get_next_code', 'WL-2014-0001', 0),
	...
	('2b0dce39-561a-42a8-835c-f488a6a63945', 'payment_code', '付款凭证号', '3712', 'FK', b'0', '2014-08-08 23:51:57', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-09-06 08:30:57', 'mysql.get_next_code', 'FK-2014-0001', 0),
	...
	('454bc450-6bd1-434b-af64-2f7b402aaccb', 'project_code', '项目编号', '8', 'XM', b'0', '2014-08-05 23:07:35', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-09-06 08:47:01', 'mysql.get_next_code', 'XM-2014-0001', 10),
...
INSERT INTO `t_sys_user` (`id`, `login_name`, `real_name`, `organization_id`, `password`, `last_login_ip`, `last_login_time`, `fails`, `logined`, `position`, `enabled`, `order_by`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`, `must_change_password`) VALUES
	('96ef9340-e169-4024-b7e5-ca7070b367fa', 'cqiyi', '成七一', '0ed44f90-0c3a-11e4-9300-001c42328937', '5be9a0e6cd0e287f09555a88abcca799803d66864b24f9ccf107f0030686cfdb', '10.211.55.3', '2014-09-06 14:25:32', 0, 62, '系统管理员', b'1', 20, '2014-08-03 10:18:48', '', '2014-09-06 14:25:32', '96ef9340-e169-4024-b7e5-ca7070b367fa', '', 74, b'0'),
