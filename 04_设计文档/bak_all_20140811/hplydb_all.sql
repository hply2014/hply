...
into next_id , next_code from
    t_sys_parameter
where
    upper(en_name) = arg0
        and EXTRACT(YEAR FROM update_time) = EXTRACT(YEAR FROM now());
set next_id = next_id + 1;
update t_sys_parameter 
set 
    param_value = next_id,
    update_time = now(),
    update_user = 'FUNCTION.get_next_code'
where
    upper(en_name) = arg0;
...
-- 正在导出表  hplydb.t_arrears 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `t_arrears` DISABLE KEYS */;
INSERT INTO `t_arrears` (`id`, `project_id`, `funds_using`, `arrears_type`, `pay_type`, `amount`, `interest_amount`, `interest_rate`, `bank_account`, `bank_name`, `trice`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`, `status`, `arrears_code`) VALUES
	('a934f3c6-b512-4015-857a-7ef4536a7620', NULL, '', '', '', 0.0000, 0.0000, 0.0000, '', '', '2014-08-10 08:00:00', '2014-08-10 12:09:06', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 12:09:06', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, 1, 'WL-2014-0005'),
	('fecc10c3-ca5c-4d61-bb1d-18b1fa29b453', NULL, '', '', '', 0.0000, 0.0000, 0.0000, '', '', '2014-08-14 08:00:00', '2014-08-10 10:46:24', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 10:46:24', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, 1, 'WL-2014-0004'),
	('fecc10c3-ca5c-4d61-bb1d-18b1fa29b454', NULL, '', '', '', 0.0000, 0.0000, 0.0000, '', '', '2014-08-14 08:00:00', '2014-08-10 10:46:24', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 10:46:24', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, 1, 'WL-2014-0001');
...
-- 正在导出表  hplydb.t_chop 的数据：~1 rows (大约)
...
-- 正在导出表  hplydb.t_collections 的数据：~0 rows (大约)
...
-- 正在导出表  hplydb.t_contract_change 的数据：~6 rows (大约)
...
INSERT INTO `t_contract_change` (`id`, `project_id`, `csa_code`, `management_rate`, `change_amount`, `trice`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`, `status`) VALUES
	...
	('7fa3e71b-4cfc-48f1-8a1e-4d612f6ca363', 'a043e829-9c2a-4b92-9c42-36affd2e53c7', 'BC-2014-0031', 3.6000, 5000.0000, '2014-08-11 22:23:04', '2014-08-11 22:23:04', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-11 22:23:04', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, NULL),
	...
	('f54e4cc7-5ffd-4c99-8bdf-f018764016ba', 'a043e829-9c2a-4b92-9c42-36affd2e53c7', 'BC-2014-0030', 3.6000, 300.0000, '2014-08-11 22:20:20', '2014-08-11 22:20:20', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-11 22:20:20', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, NULL);
...
-- 正在导出表  hplydb.t_customer_billing 的数据：~1 rows (大约)
...
-- 正在导出表  hplydb.t_information 的数据：~2 rows (大约)
...
INSERT INTO `t_party_billing` (`id`, `project_id`, `invoice_code`, `amount`, `trice`, `tax_rate`, `tax_amount`, `step1_idea`, `step1_user`, `step1_time`, `step_status`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`, `status`) VALUES
	('83491638-7be7-4610-ab14-f6f85834bd59', 'e6f4c8e6-4976-46d2-ab1d-dc0d4487d4fd', '三十岁', 300.0000, '2014-08-11 23:48:47', 3.6000, 0.0000, NULL, NULL, NULL, NULL, '2014-08-11 22:33:40', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-11 23:48:47', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 1, NULL),
	...
	('92b1d64a-00c5-4192-85cc-a9c02607c81d', NULL, '', 888.0000, '2014-08-10 08:00:00', 5.0000, 888.0000, '', '', NULL, '', '2014-08-10 10:48:31', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 10:48:31', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, 1),
	('c4753ed2-dcb8-42bd-80f9-3de477453954', NULL, '鹅鹅鹅鹅', 20000.0000, '2014-08-10 08:00:00', 3.6000, 300.0000, '', '', NULL, '', '2014-08-10 19:23:49', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 19:23:49', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 0, 1);
...
-- 正在导出表  hplydb.t_payment 的数据：~0 rows (大约)
...
-- 正在导出表  hplydb.t_profile 的数据：~1 rows (大约)
...
-- 正在导出表  hplydb.t_project 的数据：~9 rows (大约)
...
INSERT INTO `t_project` (`id`, `project_code`, `project_name`, `organization_id`, `party_name`, `party_address`, `manager`, `contract_code`, `corperation`, `legal_assignee`, `is_withholding_offsite`, `management_rate`, `tax_rate`, `contract_amount`, `settlement_amount`, `duty_paid_time`, `duty_paid_amount`, `duty_paid_code`, `capital_occupied`, `project_status`, `trice`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`, `status`, `management_plan_amount`, `tax_plan_amount`) VALUES
	...
	('eb549da6-8830-4319-b01c-ba29011481a6', 'XM-2014-0110', '今天的项目', '0ed4d3a1-0c3a-11e4-9300-001c42328937', '', '', '成七一', '', '', '', NULL, 3.6000, 3.4000, 500000.0000, 0.0000, NULL, 0.0000, '', 0.0000, NULL, '2014-08-11 22:31:58', '2014-08-11 22:31:57', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-11 22:31:57', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '这一个新项目了。', 0, NULL, 18000.0000, 17000.0000),
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='00_多项目汇总';

-- 正在导出表  hplydb.t_project_summary 的数据：~6 rows (大约)
...
-- 正在导出表  hplydb.t_sys_authorization 的数据：~69 rows (大约)
...
INSERT INTO `t_sys_parameter` (`id`, `en_name`, `cn_name`, `param_value`, `default_value`, `is_inner`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`) VALUES
	('0b8f1d89-8655-463a-97be-b8b033d29a8c', 'collections_code', '收款凭证号', '4', 'SK', b'0', '2014-08-08 23:47:26', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 19:27:46', 'FUNCTION.get_next_code', 'SK-2014-0001', 4),
	...
	('1fdae036-8ba5-4ad5-ad43-e68e38eda5e0', 'arrears_code', '往来欠款凭证号', '7', 'WL', b'0', '2014-08-08 23:52:38', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 20:29:02', 'FUNCTION.get_next_code', 'WL-2014-0001', 0),
	...
	('2b0dce39-561a-42a8-835c-f488a6a63945', 'payment_code', '付款凭证号', '4', 'FK', b'0', '2014-08-08 23:51:57', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '2014-08-10 20:31:25', 'FUNCTION.get_next_code', 'FK-2014-0001', 0),
...
-- 正在导出表  hplydb.t_sys_resource 的数据：~0 rows (大约)
...
-- 正在导出表  hplydb.t_sys_user 的数据：~14 rows (大约)
...
INSERT INTO `t_sys_user` (`id`, `login_name`, `real_name`, `organization_id`, `password`, `last_login_ip`, `last_login_time`, `fails`, `logined`, `position`, `enabled`, `order_by`, `create_time`, `create_user`, `update_time`, `update_user`, `description`, `version`, `must_change_password`) VALUES
	...
	('a5bf7c7c-0c3a-11e4-9300-001c42328937', 'zhangmeng', '张梦', '0ed4d3a1-0c3a-11e4-9300-001c42328937', '2294ae17936ae620d46f9936f0a6896fe5375eb8b61059953edb32fb70b6313f', '10.211.55.3', '2014-08-11 23:48:12', 0, 101, '财务经理，系统管理员', b'1', 2, '2014-07-16 00:11:15', '', '2014-08-11 23:48:11', 'a5bf7c7c-0c3a-11e4-9300-001c42328937', '', 118, b'0'),
...
-- 导出  触发器 hplydb.tr_arrears 结构
DROP TRIGGER IF EXISTS `tr_arrears`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_arrears` AFTER INSERT ON `t_arrears` FOR EACH ROW BEGIN
...
-- 导出  触发器 hplydb.tr_collections 结构
DROP TRIGGER IF EXISTS `tr_collections`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_collections` AFTER INSERT ON `t_collections` FOR EACH ROW BEGIN
INSERT INTO `t_project_summary`
(`id`,
`trice`,
`description`,
...
-- 导出  触发器 hplydb.tr_contract_change 结构
DROP TRIGGER IF EXISTS `tr_contract_change`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_contract_change` AFTER INSERT ON `t_contract_change` FOR EACH ROW BEGIN
INSERT INTO `t_project_summary`
(`id`,
`trice`,
`description`,
...
-- 导出  触发器 hplydb.tr_customer_billing 结构
DROP TRIGGER IF EXISTS `tr_customer_billing`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_customer_billing` AFTER INSERT ON `t_customer_billing` FOR EACH ROW BEGIN
...
-- 导出  触发器 hplydb.tr_party_billing 结构
DROP TRIGGER IF EXISTS `tr_party_billing`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_party_billing` AFTER UPDATE ON `t_party_billing` FOR EACH ROW BEGIN
...
-- 导出  触发器 hplydb.tr_payment 结构
DROP TRIGGER IF EXISTS `tr_payment`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_payment` AFTER INSERT ON `t_payment` FOR EACH ROW BEGIN
...
-- 导出  触发器 hplydb.tr_profile 结构
DROP TRIGGER IF EXISTS `tr_profile`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_profile` AFTER INSERT ON `t_profile` FOR EACH ROW BEGIN
...
-- 导出  触发器 hplydb.tr_project 结构
DROP TRIGGER IF EXISTS `tr_project`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tr_project` AFTER INSERT ON `t_project` FOR EACH ROW BEGIN
    INSERT INTO `t_project_summary`
(`id`,
`trice`,
`description`,
