CREATE TABLE `t_field_types` (
  ...
  `field_t06` datetime DEFAULT NULL,
...
CREATE TABLE `t_collections` (
  ...
  `amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '收款金额',
  `bank_account` varchar(50) DEFAULT NULL COMMENT '银行账号',
  `bank_name` varchar(200) DEFAULT NULL COMMENT '开户行名称',
...
CREATE TABLE `t_contract_change` (
  ...
  `management_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '管理费率',
  `change_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '增减金额',
...
CREATE TABLE `t_customer_billing` (
  ...
  `amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '发票金额',
...
CREATE TABLE `t_party_billing` (
  ...
  `amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '发票金额',
  `trice` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '开票时间',
  `tax_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '税率',
  `tax_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '应收税金',
...
CREATE TABLE `t_payment` (
  ...
  `amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '付款金额',
  `bank_account` varchar(50) DEFAULT NULL COMMENT '银行账号',
  `bank_name` varchar(200) DEFAULT NULL COMMENT '开户行名称',
...
CREATE TABLE `t_payment_item` (
  ...
  `reimbursement_cap` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '报销比例上限',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user` char(36) DEFAULT NULL COMMENT '创建用户',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  `update_user` char(36) DEFAULT NULL COMMENT '修改用户',
...
CREATE TABLE `t_profile` (
  `id` char(36) NOT NULL COMMENT 'ID',
  `project_id` char(36) DEFAULT NULL COMMENT '项目ID',
  `expected_value` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '预计用量',
...
CREATE TABLE `t_project` (
  ...
  `management_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '管理费率',
  `tax_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '税金比率',
  `contract_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '合同金额',
  `settlement_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '结算金额',
  `duty_paid_time` datetime DEFAULT NULL COMMENT '印花税上交时间',
  `duty_paid_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '印花税上交金额',
  `duty_paid_code` varchar(50) DEFAULT NULL COMMENT '印花税收据编号',
  `capital_occupied` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '占用资金情况',
...
CREATE TABLE `t_project_summary` (
  ...
  `project_name` varchar(100) DEFAULT NULL COMMENT '项目名称',
  `contract_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '合同金额',
  `change_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '合同调增额',
  `settlement_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '合同结算额',
  `management_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '比率',
  `management_plan_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '应收管理费',
  `management_real_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '实收管理费',
  `management_total_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '累计收管理费',
  `management_owe_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '尚欠管理费',
  `party_billing_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '发票金额',
  `party_billing_total_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '累计开票',
  `collections_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '收款金额',
  `collections_total_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '累计收款',
  `collections_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '回收率',
  `customer_billing_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '发票金额',
  `customer_billing_total_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '累计开票',
  `payment_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '支付金额',
  `payment_total_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '累计',
  `tax_rate` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '比率',
  `tax_plan_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '应缴税金',
  `tax_real_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '已缴税金',
  `tax_total_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '累计已缴税金',
  `tax_owe_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '尚欠税金',
  `arrears_amount` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '金额',
  `expected_value` DECIMAL(20,4) NOT NULL DEFAULT 0 COMMENT '预计用量',
  `profile_point` varchar(100) DEFAULT NULL COMMENT '型材点',
  `version` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
