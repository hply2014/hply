...
-- Dumping structure for table hplydb_new.t_sys_fields
CREATE TABLE IF NOT EXISTS `t_sys_fields` (
...
-- Dumping data for table hplydb_new.t_sys_fields: ~0 rows (approximately)
/*!40000 ALTER TABLE `t_sys_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_sys_fields` ENABLE KEYS */;
