...
public class Arrears implements Serializable {
	...
	public String toString() {
		...
		str += MessageFormat.format("InterestAmount=\"{0}\",",
				this.getInterestAmount());
		str += MessageFormat.format("InterestRate=\"{0}\",",
		...
		str += MessageFormat
				.format("FundsUsing=\"{0}\",", this.getFundsUsing());
		;
		return str;
