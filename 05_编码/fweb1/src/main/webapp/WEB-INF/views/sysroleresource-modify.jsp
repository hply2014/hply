...
<div class="container main">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<sf:form modelAttribute="sysRoleResource" cssClass="form-horizontal" role="form">
				<div class="row">
					<div class="col-sm-8">
						<div class="row">
							...
							<div class="col-sm-4 required-field-block">
								...
								<sf:input cssClass="form-control" path="roleId" placeholder="" />
								<p class="help-block">&nbsp;</p>
							</div>
							<label for="resourceId" class="col-sm-2 control-label"></label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
						...
						<a href='<s:url value="/sysroleresource" />' class="btn btn-link"><span
