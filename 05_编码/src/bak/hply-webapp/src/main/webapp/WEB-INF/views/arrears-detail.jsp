...
<shiro:hasPermission name="`arrears_modify`">
                ...
                <shiro:hasPermission name="`arrears_delete`">
				<div class="btn-group">
					<a
...
<sf:form modelAttribute="arrears" cssClass="form-horizontal"
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${arrears.serialId}" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		<sf:label path="offsetAmount" cssClass="col-sm-2 control-label">累计欠款本金</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatNumber pattern="#,##0.00" value="${arrears.offsetAmount}" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${arrears.trice}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${arrears.createTime}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${arrears.updateTime}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
		</div>
	</div>
