...
<sf:form modelAttribute="projectSummary" cssClass="form-horizontal"
	...
	<div class="form-group">
		<sf:label path="serialId" cssClass="col-sm-2 control-label">记录流程号</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${projectSummary.serialId}" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		<sf:label path="changeTotalAmount" cssClass="col-sm-2 control-label">累计调增额</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatNumber pattern="#,##0.00" value="${projectSummary.changeTotalAmount}" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${projectSummary.createTime}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
		</div>
	</div>

	<div class="form-group">
		<sf:label path="tableName" cssClass="col-sm-2 control-label"></sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${projectSummary.tableName}" /></p>
		</div>
	</div>
</sf:form>
  </div>
