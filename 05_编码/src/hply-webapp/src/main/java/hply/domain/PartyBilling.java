...
public class PartyBilling implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8525006959072249604L;
		/*
    	 * ID
    	 */
         ...
         * 销项税金
         */
        public static final String FIELD_OUTPUT_TAX_AMOUNT = "output_tax_amount";
    	/*
    	 * 发票金额
    	 */
    ...
    /**
      ...
      */
      ...
      private double outputTaxAmount;
    ...
    /**
      ...
      */
       ...
       /**
        ...
        /**
         * [output_tax_amount] getter，
         * 销项税金
         */
       	public double getOutputTaxAmount () {
       		return this.outputTaxAmount;
       	}

       /**
         * [output_tax_amount] setter，
         * 销项税金
         */
       	public void setOutputTaxAmount(double outputTaxAmount) {
       		this.outputTaxAmount = outputTaxAmount;
       	}
        /**
	...
	public String toString() {
        ...
        str += MessageFormat.format("OutputTaxAmount=\"{0}\",", this.getOutputTaxAmount());
