...
/**
  ...
  * 10+A_信息登记补充修改表
  */
public class InformationChange implements Serializable {
	...
	private static final long serialVersionUID = -7141284040589002950L;
    	 ...
    	 * 原值
    	 */
        public static final String FIELD_ORIGINAL_DATA = "original_data";
    	/*
    	 * 新值
    	 */
        public static final String FIELD_NEW_DATA = "new_data";
    	/*
    	 * 创建时间
    	 */
	...
	public String toString() {
        ...
        str += MessageFormat.format("OriginalData=\"{0}\",", StringUtils.trimToEmpty(this.getOriginalData()));
        str += MessageFormat.format("NewData=\"{0}\",", StringUtils.trimToEmpty(this.getNewData()));
