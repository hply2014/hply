...
/**
  ...
  * 异地税金
  */
public class PaymentDifferentTaxAmount implements Serializable {
	 ...
	 * 默认构造函数
	 */
	public PaymentDifferentTaxAmount() {
	...
	public String toString() {
        ...
        str += MessageFormat.format("PaymentId=\"{0}\",", StringUtils.trimToEmpty(this.getPaymentId()));
