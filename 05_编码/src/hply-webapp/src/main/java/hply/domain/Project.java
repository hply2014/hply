...
public class Project implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6794609513593684030L;
		/*
    	 * ID
    	 */
	...
	public Project() {
        ...
        this.vatAdditionalCoefficient = 1.12;
	}
	...
	public double[] getTrTaxRates() {
		return trTaxRates;
	}

	public void setTrTaxRates(double[] trTaxRates) {
		this.trTaxRates = trTaxRates;
	}

	public double[] getTrAmounts() {
		return trAmounts;
	}

	public void setTrAmounts(double[] trAmounts) {
		this.trAmounts = trAmounts;
	}

	public Integer[] getTrStatuss() {
		return trStatuss;
	}

	public void setTrStatuss(Integer[] trStatuss) {
		this.trStatuss = trStatuss;
	}
	...
	public String toString() {
        ...
        str += MessageFormat.format("ContractTaxRate=\"{0}\",", this.getContractTaxRate());
