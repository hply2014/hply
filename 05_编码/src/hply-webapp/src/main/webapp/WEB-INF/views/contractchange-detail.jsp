		...
		<div class="panel-body">
			...
			<sf:form modelAttribute="contractChange" cssClass="form-horizontal"
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${contractChange.managementRate}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${contractChange.trice}"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${contractChange.createTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${contractChange.updateTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
