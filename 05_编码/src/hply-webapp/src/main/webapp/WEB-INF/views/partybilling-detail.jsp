		...
		<div class="panel-body">
			...
			<sf:form modelAttribute="partyBilling" cssClass="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${partyBilling.trice}"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${partyBilling.step1Time}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${partyBilling.createTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${partyBilling.updateTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
