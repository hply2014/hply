	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="btn-toolbar" role="toolbar">
				...
				<div class="btn-group">
					<a
						data-confirm-message="删除后不可恢复，您确认要删除【<c:out value="${fieldTypes.id}" />】么？"
			...
			<sf:form modelAttribute="fieldTypes" cssClass="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${fieldTypes.fieldT03}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${fieldTypes.fieldT04}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${fieldTypes.fieldT06}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${fieldTypes.fieldT07}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${fieldTypes.fieldT09}" />
						</p>
					</div>
				</div>
			</sf:form>
