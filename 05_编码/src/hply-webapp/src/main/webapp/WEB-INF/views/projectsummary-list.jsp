...
<%@ include file="header.jsp"%><div class="container main">
	<c:if test="${not empty message}">
		...
		<div
			...
			<strong><a
				href="<s:url value="/projectsummary/detail/${projectSummary.id }" />">
		...
		<div class="panel-body">
			<div class="btn-toolbar" role="toolbar">
				<div class="btn-group">
					...
					<a href="<c:url value="/projectsummary/create" />"
				...
				<tbody>
					...
					<c:forEach items="${list}" var="projectSummary">
						<tr>
							...
							<td><c:out
									value="${projectSummary.customerBillingTotalAmount}" /></td>
							...
							<td><c:if test="${project.status == 1 }">
								...
								href="<s:url value="/projectsummary/delete/{id}"><s:param name="id" value="${projectSummary.id }" /></s:url>">删除</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
