                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                            	<a href="javascript:showArrearsTypesFormDialog('${arrearsTypesId }');" class="btn btn-link"><span
                        ...
                        <a href='<s:url value="/arrears" />' onclick="return goback();" class="btn btn-link"><span
...
<!--/container main -->
<script type="text/template" charset="utf-8" id='arrearsTypesEditTemplate'>
<form id="arrearsTypesForm" class="form-horizontal" role="form">
	<input type="hidden" id="id" value=""/>
	<div class="row">
		<label for="paramValue" class="col-sm-2 control-label">参数值</label>
    	<div class="col-sm-10">
			<div class="input-group">
  				<span class="input-group-addon" id="paramValueLock">垫资/押金/利息/</span>
...
<script type="text/javascript">
	$(function() {
		...
		$("#myModalContent").delegate("#paramValue","blur",function(){
			if($('#arrearsTypesForm').find("#paramValue").val()){
	...
	function showArrearsTypesFormDialog(id) {
    	$.get("<s:url value='/sysparameter/get/'/>" + id + ".json", {},
			function(result) {
				$("#myModal .modal-title").html("欠款分类参数修改");
				$("#myModalContent").html(templateContent("arrearsTypesEditTemplate"));
				$('#arrearsTypesForm').find("#id").val(result.id);
				var paramValues = [];
				$.each(result.paramValue.split("/"), function(){
					if(this != "垫资" && this != "押金" && this != "利息"){
						paramValues.push(this);
					}
				});
