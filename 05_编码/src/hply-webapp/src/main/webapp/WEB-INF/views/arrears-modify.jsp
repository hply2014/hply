					...
					<div class="col-sm-8">
						...
						<div class="row">
							...
							<div class="col-sm-8 required-field-block">
								...
								<sf:select cssClass="form-control select2" path="projectId" items="${projectlist }" itemValue="id"
						...
						<div class="row">
							...
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
								<sf:select cssClass="form-control selectpicker" path="arrearsType" items="${arrearsTypes }" />
								<p class="help-block" />
							</div>
						...
						<a href='<s:url value="/arrears" />' class="btn btn-link"><span class="glyphicon glyphicon-share-alt"></span>
							返 回 </a>
