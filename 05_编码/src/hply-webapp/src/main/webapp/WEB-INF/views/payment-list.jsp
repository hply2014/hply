...
<div class="btn-toolbar" role="toolbar">
  <div class="btn-group">
  <a href="<c:url value="/payment/create" />" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span> 新 建 </a>
</div>
</div>
		...
		<c:forEach items="${list}" var="payment">
			<tr>
				...
				<td><a
					...
					| <a class="delete" data-confirm-message="删除后不可恢复，您确认要删除【<c:out value="${payment.id}" />】么？"
					href="<s:url value="/payment/delete/{id}"><s:param name="id" value="${payment.id }" /></s:url>">删除</a></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
