	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="btn-toolbar" role="toolbar">
				...
				<div class="btn-group">
					<a
						data-confirm-message="删除后不可恢复，您确认要删除【<c:out value="${customerBilling.id}" />】么？"
			...
			<sf:form modelAttribute="customerBilling" cssClass="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${customerBilling.trice}"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${customerBilling.createTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${customerBilling.updateTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
