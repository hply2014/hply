    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="btn-toolbar" role="toolbar">
                <div class="btn-group">
                    <a href="<s:url value="/sysorganization" />" class="btn btn-info"><span
                ...
                <div class="btn-group">
                    <a data-confirm-message="组织机构数据：<c:out value="${sysOrganization.id}" />，将被永久删除，操作不可撤销，是否确认？"
            ...
            <sf:form modelAttribute="sysOrganization" cssClass="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${sysOrganization.organizationName}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatDate value="${sysOrganization.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${sysOrganization.description}" />
                        </p>
                    </div>
                </div>
            </sf:form>
