...
<body>
    <h4>
        ...
        行 ）
        <span id="offsetMonths">${orgName }，${p1 }01月01日 ~ ${p1 }12月31日</span>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="<c:url value="/projectsummary/export-year-detail?orgid=${orgId }&p1=${p1 }" />" class="btn btn-danger"><span
    ...
    <c:set var="rowspan" value="1"/>
   	...
   	<c:if test="${empty columns || fn:contains(columns,'projectCode') || fn:contains(columns,'projectName') || fn:contains(columns,'field03') || fn:contains(columns,'contractTaxRate') || fn:contains(columns,'contractAmount') || fn:contains(columns,'contractType') || fn:contains(columns,'changeTotalAmount') || fn:contains(columns,'settlementAmount')}">
		...
		$(function() {
			...
			$("#btn-setting").click(function(){
				...
				$("#myModal .btn-danger").off("click").on("click",function() {
			    	...
			    	$.post("<s:url value='/sysuser/setting/yeardetail'/>", {setting: JSON.stringify(data)},
		    			function(result) {
		    				//未提交成功，提示错误
