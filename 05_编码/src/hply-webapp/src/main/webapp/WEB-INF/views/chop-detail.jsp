	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="btn-toolbar" role="toolbar">
				<div class="btn-group">
					<a href="<s:url value="/chop" />" class="btn btn-info"><span
			...
			<sf:form modelAttribute="chop" cssClass="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${chop.applyTime}"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${chop.step1Time}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${chop.step2Time}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${chop.step3Time}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
