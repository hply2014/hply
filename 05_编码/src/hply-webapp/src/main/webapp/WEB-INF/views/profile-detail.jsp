	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="btn-toolbar" role="toolbar">
				<div class="btn-group">
					<a href="<s:url value="/profile" />" class="btn btn-info"><span
				...
				<shiro:hasPermission name="`project_delete`">
					<div class="btn-group">
						<a
							data-confirm-message="删除后不可恢复，您确认要删除【<c:out value="${profile.id}" />】么？"
			...
			<sf:form modelAttribute="profile" cssClass="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${profile.profilePoint}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${profile.trice}"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${profile.createTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${profile.createUser}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${profile.updateTime}"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<c:out value="${profile.updateUser}" />
						</p>
					</div>
				</div>
