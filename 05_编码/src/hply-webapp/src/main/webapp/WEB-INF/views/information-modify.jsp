                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="address" placeholder="地址" />
                                <p class="help-block" />
                            </div>

                            <label for="developer" class="col-sm-2 control-label">开发商</label>
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="developer" placeholder="开发商" />
                                <p class="help-block" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="epcCorporation" placeholder="总包单位" />
                                <p class="help-block" />
                            </div>

                            <label for="variety" class="col-sm-2 control-label">品种</label>
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="variety" placeholder="品种" />
                                <p class="help-block" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="totalArea" placeholder="总面积" />
                                <p class="help-block" />
                            </div>

                            <label for="realName" class="col-sm-2 control-label">姓名</label>
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="realName" placeholder="姓名" />
                                <p class="help-block" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="identification" placeholder="身份证号" />
                                <p class="help-block" />
                            </div>

                            <label for="contact" class="col-sm-2 control-label">联系方式</label>
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="contact" placeholder="联系方式" />
                                <p class="help-block" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 ">
                                <sf:input cssClass="form-control" path="subscriber" placeholder="登记人" />
                                <p class="help-block" />
                            </div>
