    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="btn-toolbar" role="toolbar">
                <div class="btn-group">
                    <a href="<s:url value="/projectsummary" />" class="btn btn-info"><span
                        class="glyphicon glyphicon-share-alt"></span> 返 回 </a>
                </div>
                <shiro:hasPermission name="`projectsummary_modify`">
                    <div class="btn-group">
                        <a
                            href="<s:url value="/projectsummary/modify/{id}"><s:param name="id" value="${projectSummary.id }" /></s:url>"
                            class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span> 修 改 </a>
                    </div>
                </shiro:hasPermission>
                <shiro:hasPermission name="`projectsummary_delete`">
                    <div class="btn-group">
                        <a data-confirm-message="多项目汇总数据：<c:out value="${projectSummary.id}" />，将被永久删除，操作不可撤销，是否确认？"
                            href="<s:url value="/projectsummary/delete/{id}"><s:param name="id" value="${projectSummary.id }" /></s:url>"
                            class="btn btn-info delete"><span class="glyphicon glyphicon-trash"></span> 删 除 </a>
                    </div>
                </shiro:hasPermission>
            </div>

            <sf:form modelAttribute="projectSummary" cssClass="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${projectSummary.description}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${projectSummary.projectId}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${projectSummary.organizationId}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${projectSummary.projectCode}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${projectSummary.projectName}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.contractAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.changeAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.settlementAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.managementRate}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.managementPlanAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.managementRealAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.managementTotalAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.managementOweAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.partyBillingAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.partyBillingTotalAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.collectionsAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.collectionsTotalAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.collectionsRate}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.customerBillingAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.customerBillingTotalAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.paymentAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.paymentTotalAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.taxRate}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.taxPlanAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.taxRealAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.taxTotalAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.taxOweAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.arrearsAmount}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${projectSummary.expectedValue}" />
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <c:out value="${projectSummary.profilePoint}" />
                        </p>
                    </div>
                </div>
