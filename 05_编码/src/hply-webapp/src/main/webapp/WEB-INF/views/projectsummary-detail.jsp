	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="btn-toolbar" role="toolbar">
				...
				<div class="btn-group">
					<a
						data-confirm-message="删除后不可恢复，您确认要删除【<c:out value="${projectSummary.id}" />】么？"
			...
			<sf:form modelAttribute="projectSummary" cssClass="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatDate value="${projectSummary.trice}"
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.contractAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.changeAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.settlementAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.managementRate}" />
						</p>
					</div>
				</div>

				<div class="form-group">
					<sf:label path="managementPlanAmount"
						cssClass="col-sm-2 control-label">应收管理费</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="managementRealAmount"
						cssClass="col-sm-2 control-label">实收管理费</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="managementTotalAmount"
						cssClass="col-sm-2 control-label">累计收管理费</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="managementOweAmount"
						cssClass="col-sm-2 control-label">尚欠管理费</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.managementOweAmount}" />
						</p>
					</div>
				</div>

				<div class="form-group">
					<sf:label path="partyBillingAmount"
						cssClass="col-sm-2 control-label">发票金额</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="partyBillingTotalAmount"
						cssClass="col-sm-2 control-label">累计开票</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="collectionsAmount"
						cssClass="col-sm-2 control-label">收款金额</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="collectionsTotalAmount"
						cssClass="col-sm-2 control-label">累计收款</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.collectionsRate}" />
						</p>
					</div>
				</div>

				<div class="form-group">
					<sf:label path="customerBillingAmount"
						cssClass="col-sm-2 control-label">发票金额</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="customerBillingTotalAmount"
						cssClass="col-sm-2 control-label">累计开票</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					<sf:label path="paymentTotalAmount"
						cssClass="col-sm-2 control-label">累计</sf:label>
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.taxPlanAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.taxRealAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.taxTotalAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.taxOweAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.arrearsAmount}" />
						</p>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="form-control-static">
							<fmt:formatNumber pattern="#,##0.00"
								value="${projectSummary.expectedValue}" />
						</p>
					</div>
				</div>
