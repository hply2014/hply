<%@ page import="com.hhwy.fresource2.core.*"%>
...
<title>${page_title}- 恒华统一资源平台</title>
<link rel="stylesheet"
	href="<s:url value="/assets/bootstrap/css/bootstrap.min.css" />">
<link rel="stylesheet"
	href="<s:url value="/assets/bootstrap/css/bootstrap-theme.min.css" />">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<s:url value="/assets/bootstrap-select/css/bootstrap-select.css" />">
<link rel="stylesheet"
	href="<s:url value="/assets/bootstrap-icheck/skins/all.css" />">
<link rel="stylesheet"
	href="<s:url value="/assets/magicsuggest/magicsuggest.css" />">
	...
	<div class="navbar navbar-inverse navbar-fixed-top bs-docs-nav">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-sm" href="<s:url value="/" />">恒华统一资源平台</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<%
						request.setAttribute("navigationTree", SessionHelper.getMenuRoot()
								.getChildren());
					%>
