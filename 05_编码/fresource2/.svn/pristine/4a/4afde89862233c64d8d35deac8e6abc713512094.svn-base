...
<div class="container main"><div class="panel panel-default">
	...
	<div class="panel-body">
        ...
        <div class="row">
							<label for="orgCode" class="col-sm-2 control-label">机构编码</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>

								<sf:input cssClass="form-control" path="orgCode"
									placeholder="机构编码" />
							...
							<div class="col-sm-4 required-field-block">
								...
								<sf:input cssClass="form-control" path="orgName"
									placeholder="机构名称" />
								<p class="help-block">&nbsp;</p>
							</div>
        ...
        <div class="row">
							<label for="orderId" class="col-sm-2 control-label"></label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
        ...
        <div class="row">
					...
					<div class="input-group date">
						...
						<span class="input-group-addon"><i
							...
							<label for="ext01" class="col-sm-2 control-label">扩展字段1</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
        ...
        <div class="row">
							<label for="ext02" class="col-sm-2 control-label">扩展字段2</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
							...
							<label for="ext03" class="col-sm-2 control-label">扩展字段3</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
        ...
        <div class="row">
							<label for="ext04" class="col-sm-2 control-label">扩展字段4</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>
						...
						<a href='<s:url value="/sysorganization" />' class="btn btn-link"><span
