...
<div class="container main"><div class="panel panel-default">
	...
	<div class="panel-body">
        ...
        <div class="row">
							...
							<label for="organizationName" class="col-sm-2 control-label">所在机构</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>

								<sf:input cssClass="form-control" path="organizationName"
									placeholder="所在机构" />
								<p class="help-block">&nbsp;</p>
							</div>
        ...
        <div class="row">
							<label for="jobs" class="col-sm-2 control-label">职位</label>
							<div class="col-sm-4 required-field-block">
								<b class="required-icon">*</b>

								<sf:input cssClass="form-control" path="jobs"
									placeholder="职位" />
								<p class="help-block">&nbsp;</p>
							</div>
