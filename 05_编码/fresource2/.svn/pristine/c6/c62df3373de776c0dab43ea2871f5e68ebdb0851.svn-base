...
public class SysResourceController {
	...
	public String list(Model model) {
		model.addAttribute("page_title", "系统资源，包括导航，菜单和按钮");
	...
	public String detail(@PathVariable String id, Model model) {
		model.addAttribute("page_title", "系统资源，包括导航，菜单和按钮的详情信息");
	...
	public String createForm(Model model) {
		...
		model.addAttribute("page_title", "新建系统资源，包括导航，菜单和按钮");
	...
	public String updateForm(@PathVariable String id, Model model) {
		model.addAttribute("sysResource", service.get(id));
		model.addAttribute("page_title", "修改系统资源，包括导航，菜单和按钮");
		return JSP_PAGE_MODIFY;
	}
