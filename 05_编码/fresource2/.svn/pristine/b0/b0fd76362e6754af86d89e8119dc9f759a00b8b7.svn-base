...
<sf:form modelAttribute="sysUser" cssClass="form-horizontal"
	...
	<div class="form-group">
		<sf:label path="organizationName" cssClass="col-sm-2 control-label">所在机构</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysUser.organizationName}" /></p>
		</div>
	</div>

	<div class="form-group">
		<sf:label path="jobs" cssClass="col-sm-2 control-label">职位</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysUser.jobs}" /></p>
		</div>
	</div>
