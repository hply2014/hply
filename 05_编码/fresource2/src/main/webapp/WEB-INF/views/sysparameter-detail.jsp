...
<sf:form modelAttribute="sysParameter" cssClass="form-horizontal"
	...
	<div class="form-group">
		<sf:label path="paramCode" cssClass="col-sm-2 control-label">参数编码</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysParameter.paramCode}" /></p>
		</div>
	</div>

	<div class="form-group">
		<sf:label path="paramName" cssClass="col-sm-2 control-label">参数中文名称</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysParameter.paramName}" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		<sf:label path="ext01" cssClass="col-sm-2 control-label">预留扩展字段1</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysParameter.ext01}" /></p>
		</div>
	</div>

	<div class="form-group">
		<sf:label path="ext02" cssClass="col-sm-2 control-label">预留扩展字段2</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysParameter.ext02}" /></p>
		</div>
	</div>

	<div class="form-group">
		<sf:label path="ext03" cssClass="col-sm-2 control-label">预留扩展字段3</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysParameter.ext03}" /></p>
		</div>
	</div>

	<div class="form-group">
		<sf:label path="ext04" cssClass="col-sm-2 control-label">预留扩展字段4</sf:label>
		<div class="col-sm-10">
			<p class="form-control-static"><c:out value="${sysParameter.ext04}" /></p>
		</div>
	</div>
