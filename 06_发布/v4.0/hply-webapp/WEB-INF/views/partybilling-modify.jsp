                        ...
                        <c:choose>
                            <c:when test="${step1 == 1}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 ">
                                        <p class="form-control-static">
                                            <c:out value="${partyBilling.invoiceAmount}" />
                                        </p>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <label for="outputTaxAmount" class="col-sm-2 control-label">销项税金</label>
                                    <div class="col-sm-4 ">
                                        <p class="form-control-static">
                                            <c:out value="${partyBilling.outputTaxAmount}" />
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-2"></div>
                                    <button type="submit" id="btn_submit_succ" class="btn btn-success" disabled="disabled">
                                        <span class="glyphicon glyphicon-ok"></span> 同意
                                    </button>
                                    <button type="submit" id="btn_submit_dang" class="btn btn-danger sm-offset-3">
                            ...
                            <c:otherwise>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 required-field-block">
                                        <b class="required-icon">*</b>
                                        <sf:input cssClass="form-control" path="outputTaxAmount" placeholder="销项税金"/>
                                        <p class="help-block" readonly="true"/>
                                    </div>
                                </div>
                                <div class="row">
...
<script type="text/javascript">
	$(function() {
		...
		$("#invoiceAmount,#taxRate").keyup(function() {
			...
			var amount = Number(invoiceAmount/(1+Number($("#taxRate").val())/100)).toFixed(2);
			$("#amount").val(amount);
			$("#outputTaxAmount").val(Number(invoiceAmount-amount).toFixed(2));
		});
