        ...
        <div class="panel-body">
            <div class="btn-toolbar" role="toolbar">
                ...
                <shiro:hasPermission name="`customerbilling_delete`">
                    <div class="btn-group">
                        <a data-confirm-message="客户开票情况数据：<c:out value="${customerBilling.id}" />，将被永久删除，操作不可撤销，是否确认？"
            ...
            <sf:form modelAttribute="customerBilling" cssClass="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <sf:label path="amount" cssClass="col-sm-2 control-label">发票</sf:label>
                    <div class="col-sm-10">
                        <p class="form-control-static">
                ...
                <div class="form-group">
                    <sf:label path="inputTaxAmount" cssClass="col-sm-2 control-label">进项税金</sf:label>
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${customerBilling.inputTaxAmount}" />
                        </p>
                    </div>
                </div>
                <div class="form-group">
                    <sf:label path="invoiceAmount" cssClass="col-sm-2 control-label">发票金额</sf:label>
                    <div class="col-sm-10">
                        <p class="form-control-static">
                            <fmt:formatNumber pattern="#,##0.00" value="${customerBilling.invoiceAmount}" />
                        </p>
                    </div>
                </div>
