                ...
                <tbody>
                    ...
                    <c:forEach items="${list}" var="project">
                        <tr>
                            ...
                            <td><c:out value='${project.contractType}' /></td>
                            <td><fmt:formatNumber  value='${project.taxBearingRate}' pattern="#0.00" />%</td>
                            ...
                            <td class="amount">${project.field02}</td>
                    ...
                    <c:if test="${not empty total}">
						<tr class="total">
                            ...
                            <td class="amount">
                            	<fmt:formatNumber value="${total.contractTotalAmount}" pattern="###,###,###,###,##0.00" />
                                <c:if test="${not empty total.settlementTotalAmount && total.settlementTotalAmount > 0 }">
                                    <br />结算：<fmt:formatNumber value="${total.settlementTotalAmount}" pattern="###,###,###,###,##0.00" />
                                </c:if>
                            </td>
                            <td class="amount"><fmt:formatNumber value="${total.projectTotalBalance}" pattern="###,###,###,###,##0.00" /></td>
                            <td class="amount"><fmt:formatNumber value="${total.availableTotalBalance}" pattern="###,###,###,###,##0.00" /></td>
                        </tr>
                    </c:if>
                </tbody>
            </table>
