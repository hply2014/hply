                    ...
                    <div class="col-sm-8">
                        <ul class="pager">
                            <li class="${pageIndex <= 0 ? 'disabled' :'' }"><a
                                href="<s:url value='/chop'><s:param name='q' value='${queryText}'/><s:param name='oid' value='${oid}'/><s:param name='p' value='${pageIndex - 1}'/></s:url>">上一页</a></li>
                            <li class="${pageIndex + 1 >= pageCount ? 'disabled' :'' }"><a
                                href="<s:url value='/chop'><s:param name='q' value='${queryText}'/><s:param name='oid' value='${oid}'/><s:param name='p' value='${pageIndex + 1}'/></s:url>">下一页</a></li>
                        </ul>
                    </div>
