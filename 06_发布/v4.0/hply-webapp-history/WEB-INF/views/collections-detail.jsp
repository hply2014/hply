...
<div class="btn-toolbar" role="toolbar">
  <div class="btn-group">
  <a href="<s:url value="/collections" />" onclick="return goback();" class="btn btn-info"><span class="glyphicon glyphicon-share-alt"></span> 返 回  </a>
</div>
</div>
...
<sf:form modelAttribute="collections" cssClass="form-horizontal"
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${collections.trice}" pattern="yyyy-MM-dd" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${collections.createTime}" pattern="yyyy-MM-dd" /></p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<p class="form-control-static"><fmt:formatDate value="${collections.updateTime}" pattern="yyyy-MM-dd" /></p>
		</div>
	</div>
